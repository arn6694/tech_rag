#!/usr/bin/env python3
"""
Containers Documentation Scraper for RAG Pipeline
"""
...
class ContainersDocScraper:
    def __init__(self, output_dir="docs"):
        ...
        # Containers documentation sources
        self.doc_sources = {
            'containers_docs': {
                'base_url': 'https://docs.example.com/containers/',
                'guides': [
                    'index.html',
    ...
    def scrape_documentation(self):
        """Scrape all configured Containers documentation sources"""
        all_docs = []
        ...
        logger.info(f"Containers scraping complete! {len(all_docs)} documents saved")
        return all_docs

if __name__ == "__main__":
    scraper = ContainersDocScraper()
