#!/bin/bash
#
# Complete Enhanced RAG System with PDF Integration
# Optimized for Open WebUI integration with intelligent PDF organization
#
...
print_header() {
    echo -e "${PURPLE}"
    echo "=============================================================="
    echo "Enhanced Red Hat Knowledge System with PDF Integration"
    echo "Optimized for Open WebUI with Intelligent Book Organization"
    echo "=============================================================="
    echo -e "${NC}"
}
...
# Configuration
BASE_DIR="$HOME/redhat-knowledge"
BOOKS_DIR="$HOME/Books"  # User's existing books folder
PYTHON_ENV="shared-env"

# Create main directory structure
mkdir -p "$BASE_DIR"
cd "$BASE_DIR"

info "Creating enhanced knowledge system in: $BASE_DIR"

# Technology configurations with ports for Open WebUI
...
declare -A TECH_DESCRIPTIONS=(
    ["ansible"]="Ansible automation and playbook development"
    ["checkmk"]="CheckMK monitoring and alerting"
    ["rhel"]="Red Hat Enterprise Linux administration"
    ["python"]="Python programming for beginners"
    ["cybersecurity"]="Cybersecurity practices and tools"
    ["bash"]="Bash scripting and shell programming"
    ["powershell"]="PowerShell scripting and automation for beginners"
    ["containers"]="Docker and Podman container fundamentals"
)

# Create shared Python environment
info "Setting up enhanced Python environment..."
...
success "Python environment ready with PDF processing capabilities"

# Create shared libraries directory
mkdir -p shared config

# Create PDF categorization system
info "Creating intelligent PDF categorization system..."

cat > shared/pdf_categorizer.py << 'PDF_CATEGORIZER_EOF'
#!/usr/bin/env python3
"""
