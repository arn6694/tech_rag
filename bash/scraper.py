#!/usr/bin/env python3
"""
Bash Documentation Scraper for RAG Pipeline
"""
...
class BashDocScraper:
    def __init__(self, output_dir="docs"):
        ...
        # Bash documentation sources
        self.doc_sources = {
            'bash_docs': {
                'base_url': 'https://docs.example.com/bash/',
                'guides': [
                    'index.html',
    ...
    def scrape_documentation(self):
        """Scrape all configured Bash documentation sources"""
        all_docs = []
        ...
        logger.info(f"Bash scraping complete! {len(all_docs)} documents saved")
        return all_docs

if __name__ == "__main__":
    scraper = BashDocScraper()
