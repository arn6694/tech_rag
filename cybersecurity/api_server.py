#!/usr/bin/env python3
"""
Cybersecurity RAG API Server for OpenWebUI Integration
"""
...
app = FastAPI(title="Cybersecurity RAG API", version="1.0.0")
...
async def startup_event():
    global rag_pipeline
    logger.info("Initializing Cybersecurity RAG pipeline...")
    rag_pipeline = EnhancedRAGSystem(
        technology_name="cybersecurity",
        docs_dir="docs",
        pdfs_dir="pdfs", 
        chroma_db_path="vector_db",
        collection_name="cybersecurity_docs"
    )
    logger.info("Cybersecurity RAG API ready!")

@app.get("/")
async def root():
    return {"message": "Cybersecurity RAG API is running", "technology": "Cybersecurity"}
