#!/usr/bin/env python3
"""
Cybersecurity Documentation Scraper for RAG Pipeline
"""
...
class CybersecurityDocScraper:
    def __init__(self, output_dir="docs"):
        ...
        # Cybersecurity documentation sources
        self.doc_sources = {
            'cybersecurity_docs': {
                'base_url': 'https://docs.example.com/cybersecurity/',
                'guides': [
                    'index.html',
    ...
    def scrape_documentation(self):
        """Scrape all configured Cybersecurity documentation sources"""
        all_docs = []
        ...
        logger.info(f"Cybersecurity scraping complete! {len(all_docs)} documents saved")
        return all_docs

if __name__ == "__main__":
    scraper = CybersecurityDocScraper()
